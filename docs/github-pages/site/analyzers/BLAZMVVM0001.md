...
ViewModels should inherit from [`ViewModelBase`](xref:Blazing.Mvvm.ComponentModel.ViewModelBase) to ensure proper MVVM pattern implementation and lifecycle management.
...
**Warning** - This should be addressed to ensure proper MVVM functionality.
