...
This analyzer provides an automatic code fix that adds the [`[ViewModelDefinition]`](xref:Blazing.Mvvm.ComponentModel.ViewModelDefinitionAttribute) attribute to the referenced ViewModel.
