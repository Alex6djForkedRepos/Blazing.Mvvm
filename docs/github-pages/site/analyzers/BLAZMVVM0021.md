...
2. ViewModel property has [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute) attribute
3. Component inherits from [`MvvmComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmComponentBase`1), [`MvvmOwningComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmOwningComponentBase`1), or [`MvvmLayoutComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmLayoutComponentBase`1)
...
- ✅ Component inherits from [`MvvmComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmComponentBase`1), [`MvvmOwningComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmOwningComponentBase`1), or [`MvvmLayoutComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmLayoutComponentBase`1)
- ✅ Component has `[Parameter] T PropertyName { get; set; }`
- ✅ Component has `[Parameter] EventCallback<T> PropertyNameChanged { get; set; }`
- ✅ ViewModel property has [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute) attribute
- ✅ The component `[Parameter]` type is the source of truth for `EventCallback<T>`
- ✅ ViewModel types constrained to [`IViewModelBase`](xref:Blazing.Mvvm.ComponentModel.IViewModelBase) are supported, not only [`ViewModelBase`](xref:Blazing.Mvvm.ComponentModel.ViewModelBase)
...
- ✅ ViewModel property with [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute)
...
1. ✅ ViewModel property has [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute) attribute
2. ✅ EventCallback name follows `{PropertyName}Changed` convention
3. ✅ Types match exactly (including nullability)
4. ✅ Component inherits from one of the MVVM component base types ([`MvvmComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmComponentBase`1), [`MvvmOwningComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmOwningComponentBase`1), or [`MvvmLayoutComponentBase<TViewModel>`](xref:Blazing.Mvvm.Components.MvvmLayoutComponentBase`1))
...
- Use automatic two-way binding for all [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute) properties
...
- Forget to add [`[ViewParameter]`](xref:Blazing.Mvvm.ComponentModel.ViewParameterAttribute) to ViewModel properties
