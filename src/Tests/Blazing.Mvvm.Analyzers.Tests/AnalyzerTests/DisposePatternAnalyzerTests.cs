...
namespace TestNamespace
{
    ...
    [Fact]
    public async Task ViewModelWithMessengerRegistration_WithDisposeOverride_NoDiagnostic()
    {
        const string test = @"
using Blazing.Mvvm.ComponentModel;
using CommunityToolkit.Mvvm.Messaging;
...
namespace TestNamespace
{
    ...
    [Fact]
    public async Task ViewModelWithDisposableField_WithDisposeOverride_NoDiagnostic()
    {
        const string test = @"
using Blazing.Mvvm.ComponentModel;
using System.Net.Http;
