...
public class DisposePatternAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeNamedType(SymbolAnalysisContext context)
    {
        ...
        // ViewModelBase now implements IDisposable; derived ViewModels with cleanup needs
        // must override Dispose(bool disposing) to add their own resource cleanup.
        if (HasDisposeOverride(namedTypeSymbol))
        {
            return;
        }
    ...
    private static bool HasDisposeOverride(INamedTypeSymbol typeSymbol)
    {
